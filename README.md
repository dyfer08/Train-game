...
Jeu web mobile où il faut mémoriser un train TGV puis le retrouver parmi plusieurs trains en mouvement sur un circuit.
...
2. Trouvez-le sur le circuit parmi les autres trains
...
- `js/game.js` — logique du jeu et animation du circuit
